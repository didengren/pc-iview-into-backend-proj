...
function assetsPath(_path) {
  const ASSETS_DIR = process.env.VUE_APP_MIXIN ? "" : "static";
  return path.posix.join(ASSETS_DIR, _path);
}

module.exports = {
  publicPath: process.env.VUE_APP_MIXIN ? "/gold_medal_butler/" : "./", // vueConf.baseUrl, // 根域上下文目录
  // outputDir: outputDir, // 构建输出目录
  assetsDir: process.env.VUE_APP_MIXIN ? "" : "static", // 静态资源目录 (js, css, img, fonts)
